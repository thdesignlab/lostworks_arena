...
namespace Common
{
    ...
    public static class Character
    {
        ...
        {                   //hp, sp, run, boost, turn, atk%, atkI, boostI, tagI
            { 100, new int[]{ 1000, 45, 36, 60, 31, 100, 3, 2, 2, 1, 0, 10 } },            { 200, new int[]{ 1000, 40, 33, 60, 25, 110, 3, 2, 2, 1, 150, 250 } },            { 300, new int[]{ 1000, 50, 30, 70, 28, 100, 3, 2, 2, 1, 0, 80 } },            { 400, new int[]{ 1050, 40, 30, 60, 25, 105, 3, 2, 2, 1, 100, 200 } },            { 500, new int[]{ 1100, 30, 33, 65, 28, 105, 2, 2, 2, 1, 50, 150 } },            { 600, new int[]{ 1250, 45, 24, 45, 25, 100, 3, 2, 2, 1, 0, 200 } },
            { 101, new int[]{ 1050, 35, 36, 55, 36, 105, 3, 2, 2, 1, 0, 10 } },            { 201, new int[]{ 1050, 30, 33, 55, 30, 115, 3, 2, 2, 1, 150, 250 } },            { 301, new int[]{ 1050, 40, 30, 65, 33, 105, 3, 2, 2, 1, 0, 80 } },            { 401, new int[]{ 1100, 30, 30, 55, 30, 110, 3, 2, 2, 1, 100, 200 } },            { 501, new int[]{ 1150, 20, 33, 60, 33, 110, 2, 2, 2, 1, 50, 150 } },            { 601, new int[]{ 1350, 35, 24, 40, 30, 105, 3, 2, 2, 1, 0, 200 } },
    ...
    public static class Mission
    {
        ...
        public static Dictionary<int, int[]> npcWeaponDic = new Dictionary<int, int[]>()
        {
            ...
            {400, new int[]{ 1006, 2003, 1005, 2006, 4010, 4004, 5004 } },
            {401, new int[]{ 1006, 2003, 1005, 2006, 4010, 4004, 10011 } },
