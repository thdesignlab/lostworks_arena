...
namespace Common
{
    ...
    public static class Character
    {
        ...
        public static Dictionary<int, string[]> characterLineUp = new Dictionary<int, string[]>()
        {
            ...
            {601, new string[]{ "Hero6", "Vaio", "0", OBTAIN_TYPE_NONE, "10010"}},
        ...
        {                   //hp, sp, run, boost, turn, atk%, atkI, boostI, tagI
            { 100, new int[]{ 1000, 45, 36, 60, 35, 100, 3, 2, 2, 1, 0, 10 } },
            { 200, new int[]{ 1000, 40, 27, 60, 25, 110, 3, 2, 2, 1, 150, 250 } },
            { 300, new int[]{ 1000, 50, 30, 75, 30, 100, 3, 2, 2, 1, 20, 60 } },
            { 400, new int[]{ 1050, 40, 30, 60, 25, 105, 3, 2, 2, 1, 100, 200 } },
            { 500, new int[]{ 1100, 30, 33, 65, 30, 105, 2, 2, 2, 1, 50, 150 } },
            { 600, new int[]{ 1250, 45, 27, 50, 25, 100, 3, 2, 2, 0, 0, 300 } },

            { 101, new int[]{ 1050, 35, 36, 55, 40, 105, 3, 2, 2, 1, 0, 10 } },
            { 201, new int[]{ 1050, 30, 27, 55, 30, 115, 3, 2, 2, 1, 150, 250 } },
            { 301, new int[]{ 1050, 40, 30, 70, 35, 105, 3, 2, 2, 1, 20, 60 } },
            { 401, new int[]{ 1100, 30, 30, 55, 30, 110, 3, 2, 2, 1, 100, 200 } },
            { 501, new int[]{ 1200, 20, 33, 60, 35, 110, 2, 2, 2, 1, 50, 150 } },
            { 601, new int[]{ 1350, 35, 27, 45, 30, 105, 3, 2, 2, 0, 0, 300 } },

            { 10000, new int[]{ 800, 35, 25, 50, 20, 90, 4, 3, 3, 0, 50, 150 } },
            { 10001, new int[]{ 800, 35, 45, 50, 20, 90, 4, 3, 3, 1, 0, 100 } },
            { 10002, new int[]{ 800, 35, 25, 100, 20, 90, 4, 3, 3, 1, 50, 200 } },
            { 10003, new int[]{ 800, 35, 25, 50, 50, 90, 3, 3, 3, 1, 50, 250 } },
            { 10004, new int[]{ 800, 35, 25, 50, 20, 130, 3, 3, 3, 1, 50, 150 } },        };
    ...
    public static class Mission
    {
        ...
        public static Dictionary<int, int[]> npcWeaponDic = new Dictionary<int, int[]>()
        {
            ...
            {200, new int[]{ 1011, 2000, 1003, 1002, 3008, 4000, 5001 } },
            {201, new int[]{ 1011, 2000, 1003, 1002, 3008, 4000, 10003 } },
            {300, new int[]{ 1009, 2009, 2004, 2008, 4003, 4002, 5002 } },
            {301, new int[]{ 1009, 2009, 2004, 2008, 4003, 4002, 10004 } },
            {400, new int[]{ 1006, 3000, 1005, 2006, 4010, 4004, 5004 } },
            {401, new int[]{ 1006, 3000, 1005, 2006, 4010, 4004, 10011 } },
            {500, new int[]{ 1000, 2011, 4009, 4006, 3009, 4000, 5000 } },
            {501, new int[]{ 1000, 2011, 4009, 4006, 3009, 10008, 5006 } },
