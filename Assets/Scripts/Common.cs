...
namespace Common
{
    ...
    public static class Character
    {
        ...
        {                   //hp, sp, run, boost, turn, atk%, atkI, boostI, tagI
            { 100, new int[]{ 1000, 45, 36, 60, 35, 100, 3, 2, 2, 1, 0, 20 } },            { 200, new int[]{ 1000, 40, 33, 60, 25, 110, 3, 2, 2, 1, 150, 250 } },            { 300, new int[]{ 1000, 50, 30, 70, 30, 100, 3, 2, 2, 1, 20, 100 } },            { 400, new int[]{ 1050, 40, 30, 60, 25, 105, 3, 2, 2, 1, 100, 200 } },            { 500, new int[]{ 1100, 30, 33, 65, 30, 105, 2, 2, 2, 1, 50, 150 } },            { 600, new int[]{ 1250, 45, 27, 50, 25, 100, 3, 2, 2, 0, 0, 300 } },
            { 101, new int[]{ 1050, 35, 35, 55, 40, 105, 3, 2, 2, 1, 0, 20 } },            { 201, new int[]{ 1050, 30, 32, 55, 30, 115, 3, 2, 2, 1, 150, 250 } },            { 301, new int[]{ 1050, 40, 30, 65, 35, 105, 3, 2, 2, 1, 20, 100 } },            { 401, new int[]{ 1100, 30, 30, 55, 30, 110, 2, 2, 2, 1, 100, 200 } },            { 501, new int[]{ 1150, 20, 32, 60, 35, 110, 2, 2, 2, 1, 50, 150 } },            { 601, new int[]{ 1350, 35, 25, 45, 30, 105, 3, 2, 2, 0, 0, 300 } },
