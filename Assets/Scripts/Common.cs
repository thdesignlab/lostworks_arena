...
namespace Common
{
    ...
    public static class Character
    {
        ...
        public static Dictionary<int, int[]> StatusDic = new Dictionary<int, int[]>()
        {
            ...
            { 101, new int[]{ 1050, 35, 35, 55, 40, 110, 3, 2, 2, 1 , 20} },
            ...
            { 301, new int[]{ 1050, 40, 30, 55, 35, 110, 3, 2, 2, 1 , 100} },
            ...
            { 501, new int[]{ 1150, 25, 35, 55, 35, 115, 3, 2, 3, 1 , 150} },
            { 600, new int[]{ 1000, 40, 30, 70, 25, 105, 3, 2, 3, 0 , 200} },
            { 10000, new int[]{ 800, 35, 25, 50, 20, 80, 3, 3, 5, 0 , 150} },
            { 10001, new int[]{ 850, 35, 25, 55, 20, 90, 3, 3, 5, 0 , 150} },
            { 10002, new int[]{ 900, 30, 40, 50, 20, 100, 3, 3, 4, 1 , 150} },
            { 10003, new int[]{ 800, 40, 30, 65, 20, 110, 3, 2, 3, 1 , 150} },
            { 10004, new int[]{ 800, 50, 20, 40, 20, 130, 3, 2, 3, 1 , 150} },
        };
    ...
    public static class Mission
    {
        ...
        public static Dictionary<int, int[]> npcWeaponDic = new Dictionary<int, int[]>()
        {
            ...
            { 500, new int[]{ 2008, 1006, 4006, 2003, 3003, 3006, 4000 } },
            { 501, new int[]{ 2008, 1006, 4006, 2003, 3003, 10008, 10009 } },
        };
    }
